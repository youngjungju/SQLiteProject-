	...
	public static void main(String[] args) {
		...
		try {
			...
			String sql2 = "insert into g_artists (name, a_type, a_year, debut, regdate)" 
					+ "values ('슈퍼비','남성','2010년대','2015년',datetime('now','localtime'));"
					+"insert into g_artists (name, a_type, a_year, debut, regdate)" 
					+ "values ('래원','남성','2010년대','2019년',datetime('now','localtime'));"
					+"insert into g_artists (name, a_type, a_year, debut, regdate)" 
					+ "values ('빈지노','남성','2000년대','2007년',datetime('now','localtime'));";
			...
			String sql3 = "update g_artists set a_year = '2000년대,2020년대' "
					+ "where id=7 ;";
